...
const NODE_CONFIG_SCHEMAS: Record<string, FieldConfig[]> = {
  ...
  'trigger:deviceOffline': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Device Offline', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Device ID', type: 'device-select', placeholder: 'Select a device', required: true },
    { key: 'offlineThresholdMs', label: 'Offline Threshold (ms)', type: 'number', placeholder: '300000', required: false, note: 'Milliseconds since last heartbeat (default 5 min = 300000 ms)' },
  ],
  ...
  'data:storageGet': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Read Cache', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Device (must match storageSet)', type: 'device-select', required: false, note: 'Must match the device set in the corresponding Storage Set node, or leave empty for workflow-global keys.' },
    { key: 'key', label: 'Storage Key', type: 'text', placeholder: 'e.g., lastAlertTime', required: true, note: 'Value is output as {{lastAlertTime}} in downstream nodes.' },
    { key: 'defaultValue', label: 'Default Value (optional)', type: 'text', placeholder: 'Value if key not found', required: false },
  ],
  'data:storageSet': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Save Cache', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Source Device', type: 'device-select', required: false },
    { key: 'key', label: 'Storage Key', type: 'text', placeholder: 'e.g., lastAlertTime', required: true },
    { key: 'valueExpression', label: 'Value Expression', type: 'text', placeholder: '{{payload.value}} or literal', required: true },
    { key: 'ttlSeconds', label: 'TTL (seconds, optional)', type: 'number', placeholder: '3600', required: false },
  ],
  'data:opcuaRead': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Read OPC-UA Node', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'gatewayId', label: 'Gateway ID', type: 'text', placeholder: 'OPC-UA gateway ID', required: true },
    { key: 'nodeId', label: 'Node ID', type: 'text', placeholder: 'ns=2;i=1001', required: true },
    { key: 'outputField', label: 'Output Field', type: 'text', placeholder: 'e.g., opcuaValue', required: false },
  ],
  'data:opcuaWrite': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Write OPC-UA Node', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Source Device', type: 'device-select', required: false },
    { key: 'gatewayId', label: 'Gateway ID', type: 'text', placeholder: 'OPC-UA gateway ID', required: true },
    { key: 'nodeId', label: 'Node ID', type: 'text', placeholder: 'ns=2;i=1001', required: true },
    { key: 'value', label: 'Value Expression', type: 'text', placeholder: '{{payload.setpoint}} or literal', required: true },
  ],
  'logic:function': [
  ...
  'logic:switch': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Route by Status', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Source Device', type: 'device-select', required: false },
    { key: 'expression', label: 'Value Expression', type: 'text', placeholder: '{{payload.status}} or literal', required: true },
    { key: 'cases', label: 'Cases (JSON)', type: 'textarea', placeholder: '[{"match":"active","handle":"active"},{"match":"inactive","handle":"inactive"}]', required: true },
  ],
  'logic:loop': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Iterate Items', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Source Device', type: 'device-select', required: false },
    { key: 'arrayField', label: 'Array Field Path', type: 'device-field', placeholder: 'e.g., items', required: true },
    { key: 'loopNodeType', label: 'Loop Node Type', type: 'select', options: [
      { value: 'function', label: 'Function' },
      { value: 'math', label: 'Math' },
      { value: 'string', label: 'String' },
    ], required: true },
    { key: 'loopNodeConfig', label: 'Loop Node Config (JSON)', type: 'textarea', placeholder: '{}', required: false },
    { key: 'outputField', label: 'Output Field', type: 'text', placeholder: 'loopResults', required: false },
  ],
  'logic:delay': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Wait', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'delayMs', label: 'Delay (ms)', type: 'number', placeholder: '1000', required: true, note: 'Maximum 30000ms (30 seconds)' },
  ],
  'logic:mutate': [
    { key: 'label', label: 'Node Label', type: 'text', placeholder: 'e.g., Modify Fields', required: true },
    { key: 'description', label: 'Description', type: 'textarea' },
    { key: 'deviceId', label: 'Source Device', type: 'device-select', required: false },
